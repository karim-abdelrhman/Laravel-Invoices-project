                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="btn btn-outline-primary btn-block"
                                                       href="{{route('invoices_archive')}}">أرشيف الفواتير</a>
                    ...
                    <div class="modal-header">
                        ...
                        <form action="{{ route('invoices.destroy' , 'test') }}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="invoice_id" id="invoice_id" value=""><br>
                                <label for="page_num">رقم الصفحة</label>
                                <input type="text" name="page_id" id="page_num" value="1">
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="invoice_id" id="invoice_id" value=""><br>
                        <label for="page_num">رقم الصفحة</label>
                        <input type="text" name="page_id" id="page_num" value="2">
