                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($invoice_info->Value_Status == 1)
                                                            <td><span
                                                                    class="badge badge-pill badge-success">{{ $invoice_info->Status }}</span>
                                                            </td>
                                                        @elseif($invoice_info->Value_Status ==2)
                                                            <td><span
                                                                    class="badge badge-pill badge-danger">{{ $invoice_info->Status }}</span>
                                                            </td>
                                                        @else
                                                            <td><span
                                                                    class="badge badge-pill badge-warning">{{ $invoice_info->Status }}</span>
                                                            </td>
                                                        @endif
                                                    </tr>
                                            ...
                                            <div class="card card-statistics">
                                                ...
                                                <div class="table-responsive mt-15">
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                        @if(!$invoice_attachments->isEmpty())
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                           href="{{ url('View_file') }}/{{ $invoice_info->invoice_number }}/{{ $attachment->file_name }}"
                                                                           role="button"><i class="fas fa-eye"></i>&nbsp;عرض</a>
                                                                        <a class="btn btn-outline-info btn-sm"
                                                                           href="{{ url('download') }}/{{ $invoice_info->invoice_number }}/{{ $attachment->file_name }}"
