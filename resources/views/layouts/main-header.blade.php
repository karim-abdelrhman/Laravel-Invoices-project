								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="{{route('markAll')}}" class="badge badge-pill badge-warning mr-auto my-auto float-left">قراءة الكل</a>
										</div>

                                        <h6 id="notifications_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروءة : {{Auth::user()->unreadNotifications->count()}}</h6>
									...
									<div class="main-notification-list Notification-scroll">
                                        ...
                                        <div id="unread_notifications">
											<div class="mr-3">
												...
												<h5 class="notification-label mb-1">{{$notification->data['title']}}{{$notification->data['id']}}</h5>
