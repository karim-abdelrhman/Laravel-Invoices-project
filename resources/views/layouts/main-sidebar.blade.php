				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices_not_paid') }}">الفواتير الغير مدفوعة</a></li>
                                    @endcan
					...
					<li class="slide">
						<a class="side-menu__item"
                           ...
                           href="{{ url('/' . $page='#') }}"><svg
                                ...
                                class="side-menu__label">التقارير</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
                            @can('تقارير الفواتير')
